...
public class FloodQueryUtils {
    ...
    */
    ...
    public static List<FloodItem> fetchFloodData(String requestUrl){

        Log.i(LOG_TAG, "TEST: called fetchFloodData() ");
        ...
        List<FloodItem> floodData = extractItemsFromJSON(jsonResponse);
        return floodData;
    }
